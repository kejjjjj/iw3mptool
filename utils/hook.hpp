...
#define HOOK_PREFIX(x) ("kej" + std::string(x))
...
enum calling_convention : char { cc_none, cc_stdcall, cc_fastcall, cc_thiscall };
...
struct hook : public hookbase
{
	...
	decltype(auto) call(const Args... args, calling_convention cc = cc_none) const
	{
		switch (cc) {
		case cc_stdcall:
			return (reinterpret_cast<Type(__stdcall*)(Args...)>(backup))(args...);
		case cc_fastcall:
			return (reinterpret_cast<Type(__fastcall*)(Args...)>(backup))(args...);
		case cc_thiscall:
			return (reinterpret_cast<Type(__thiscall*)(Args...)>(backup))(args...);
		default:
			return (reinterpret_cast<Type(*)(Args...)>(backup))(args...);
		}
	}
	template<void(Args...)>
	void call(const Args... args, calling_convention cc = cc_none) const
	{
		switch (cc) {
		case cc_stdcall:
			return (reinterpret_cast<void(__stdcall*)(Args...)>(backup))(args...);
		case cc_fastcall:
			return (reinterpret_cast<void(__fastcall*)(Args...)>(backup))(args...);
		case cc_thiscall:
			return (reinterpret_cast<void(__thiscall*)(Args...)>(backup))(args...);
		default:
			return (reinterpret_cast<void(*)(Args...)>(backup))(args...);
		}
	}
